...
class PlaneTest {
    ...
    public void testFindIntersections() {
        ...
        assertNull(plane.findIntersections(ray3),
                "Ray is parallel and included in the plane");
        ...
        assertNull(plane.findIntersections(ray4),
                "Ray is parallel and not included in the plane");
        ...
        assertEquals(List.of(new Point(1, 1, 1)),
                    result2,
                    "Ray is orthogonal and starts before the plane");
        ...
        assertNull(plane.findIntersections(ray7),
                "Ray is orthogonal and starts after the plane");
        ...
        assertNull(plane.findIntersections(ray8),
                "Ray begins at the plane and is neither orthogonal nor parallel to it");
        ...
        assertNull(plane.findIntersections(ray9),
                "Ray begins at the reference point and is neither orthogonal nor parallel to the plane");
    }
}